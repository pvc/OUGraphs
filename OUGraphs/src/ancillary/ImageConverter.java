...
public class ImageConverter {
	...
	public void run() {
		p("Starting run of ImageCoverter at " + new Date());
		doIt();
		p("Finished run of ImageCoverter at " + new Date());
	}
	 ...
	 public static ImageData convertToSWT(BufferedImage bufferedImage) {
	  ...
	  public void doIt() {
		  doIt(createSampleImage(display));
	  }
	  public void doIt(String fileName) {
		  doIt(new ImageData(fileName));
	  }

	  public  void doIt(ImageData data) {
